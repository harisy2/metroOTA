...
#define transit_realtime_TripDescriptor_init_default {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, false, _transit_realtime_TripDescriptor_ScheduleRelationship_MIN, false, "", false, 0, false, transit_realtime_TripDescriptor_ModifiedTripSelector_init_default, NULL}
...
#define transit_realtime_TripDescriptor_init_zero {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, false, _transit_realtime_TripDescriptor_ScheduleRelationship_MIN, false, "", false, 0, false, transit_realtime_TripDescriptor_ModifiedTripSelector_init_zero, NULL}
